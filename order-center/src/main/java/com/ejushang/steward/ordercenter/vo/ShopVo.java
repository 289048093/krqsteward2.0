...
public class ShopVo {
    ...
    private String outPlatformTypeValue;
    ...
    public String getOutPlatformTypeValue() {
        return outPlatformTypeValue;
    }

    public void setOutPlatformTypeValue(String outPlatformTypeValue) {
        this.outPlatformTypeValue = outPlatformTypeValue;
    }
}
