function getLodop(oOBJECT, oEMBED) {
    ...
    var baseUrl = '';
    var strHtmInstall = "<br><p>打印控件未安装!点击这里<a href='" + baseUrl + "/assets/install_lodop32.zip'>执行安装</a>,安装后请刷新页面或重新进入。</p>";
    var strHtmUpdate = "<br><p>打印控件需要升级!点击这里<a href='" + baseUrl + "/assets/install_lodop32.zip'>执行升级</a>,升级后请重新进入。</p>";
    var strHtm64_Install = "<br><p>打印控件未安装!点击这里<a href='" + baseUrl + "/assets/install_lodop64.zip'>执行安装</a>,安装后请刷新页面或重新进入。</p>";
    var strHtm64_Update = "<br><p>打印控件需要升级!点击这里<a href='" + baseUrl + "/assets/install_lodop64.zip'>执行升级</a>,升级后请重新进入。</p>";
    var strHtmFireFox = "<br><br><p>注意：<br>1：如曾安装过Lodop旧版附件npActiveXPLugin,请在【工具】->【附加组件】->【扩展】中先卸它。</p>";
    var LODOP = oEMBED;
    try {
