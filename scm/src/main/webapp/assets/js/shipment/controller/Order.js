...
Ext.define('Supplier.controller.Order', {
    ...
    stores: ['OrderList', 'ItemList', 'StorageAll'],
        ...
        this.control({
            ...
            '#outOrder': {
                click: function (btn) {
                    ...
                    location.href = 'invoice/list_invoice_report_orders?' + Ext.Object.toQueryString(params);
                }
            },
            '#TotalOutOrder': {
                click: function (btn) {
...
//            },
            ...
            "#orderExport": {
                click: function () {
                    ...
                    location.href='/orders/excel-' + dayFormat + '.xls?' + Espide.Common.parseParam(searchFormVal);
                }
            }
