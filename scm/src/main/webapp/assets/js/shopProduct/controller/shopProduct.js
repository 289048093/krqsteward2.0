...
Ext.define('ShopProduct.controller.shopProduct', {
        extend: 'Ext.app.Controller',
        views: [
            'ShopProduct',
            'Search',
            'List',
            'addProduct.addProductWin',
            'addProduct.addProductList',
            'addProduct.addProductInfo',
            'showDetails.showDetailsWin',
            'showDetails.showProductInfo',
            'showDetails.showProductList',
        ],
        models: ['List', 'GoodList'],
        stores: ['List', 'GoodList'],
        init: function () {
            this.control({
                '#List': {
                ...
                '#addProduct': {
                    'click': function (btn) {
                        Ext.widget('addProductWin').show(this, function () {
                            var  goodListStore = Ext.getCmp('addProductList').getStore();
                            if(goodListStore.count()>0){
                                goodListStore.removeAll();
                            }
                        });
                    }
                },
...
//                    }
//                },
                '#goodSearch #searchBtn':{
                    'click': function () {
                        Espide.Common.doSearch('addProductList', 'goodSearch', true);
                    }
                },
                '#Addcomfirm': {
                    'click': function (btn) {
                        var data = Ext.getCmp('addProductInfo').getValues(),
                            ...
                            ProductIds = Espide.Common.getGridSelsId('addProductList');
