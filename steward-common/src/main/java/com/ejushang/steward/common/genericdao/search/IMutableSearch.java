 ...
 */
package com.ejushang.steward.common.genericdao.search;
...
public interface IMutableSearch extends ISearch {
    ...
    public IMutableSearch setCacheable(boolean cacheable);

    public IMutableSearch setCacheMode(CacheMode cacheMode);
}
