...
public class ZiYouLogger {
    ...
    public static void setNeedEnableLogger(boolean needEnableLogger) {
        ZiYouLogger.needEnableLogger = needEnableLogger;
    }
     ...
     * 发生特别错误时记录完整错误现场
     */
    public static void logErrorScene(Map<String, Object> rt, ZiYouResponse tRsp, String appSecret) {
        if (!needEnableLogger) {
            return;
        }
        DateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        ...
        appendLog((ZiYouHashMap) rt.get("protocalMustParams"), sb);
        sb.append("^_^");
        sb.append("ProtocalOptParams:");
        appendLog((ZiYouHashMap) rt.get("protocalOptParams"), sb);
        sb.append("^_^");
        sb.append("ApplicationParams:");
        appendLog((ZiYouHashMap) rt.get("textParams"), sb);
        sb.append("^_^");
        sb.append("Body:");
    ...
    private static void appendLog(ZiYouHashMap map, StringBuilder sb) {
        boolean first = true;
