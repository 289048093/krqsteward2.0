    ...
    private static String _doPost(String url, String ctype, byte[] content, int connectTimeout, int readTimeout,
        ...
        try {
            try {
                ...
                ZiYouLogger.logCommError(e, url, map.get(Constants.APP_KEY), map.get(Constants.METHOD_NAME), content);
                throw e;
            }
            try {
                ...
                Map<String, String> map = getParamsFromUrl(url);
                ZiYouLogger.logCommError(e, conn, map.get(Constants.APP_KEY), map.get(Constants.METHOD_NAME), content);
                throw e;
            }
    ...
    private static String _doPostWithFile(String url, Map<String, String> params, Map<String, FileItem> fileParams,
        ...
        try {
            try {
                ...
                Map<String, String> map = getParamsFromUrl(url);
                ZiYouLogger.logCommError(e, url, map.get(Constants.APP_KEY), map.get(Constants.METHOD_NAME), params);
                throw e;
            }
            ...
            try {
                ...
                Map<String, String> map = getParamsFromUrl(url);
                ZiYouLogger.logCommError(e, conn, map.get(Constants.APP_KEY), map.get(Constants.METHOD_NAME), params);
                throw e;
            }
        } finally {
            if (out != null) {
